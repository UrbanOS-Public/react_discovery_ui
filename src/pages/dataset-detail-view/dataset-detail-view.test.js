...
describe("dataset detail view", () => {
  ...
  const hostedDataset = Object.assign({}, ingestDataset, {
    sourceType: "host"
  });
  const remoteDataset = Object.assign({}, ingestDataset, {
    sourceType: "remote"
  });
  const streamingDataset = Object.assign({}, ingestDataset, {
    sourceType: "stream"
  });
  ...
  describe("DatasetView", () => {
    beforeEach(() => {
      const notCsvDataset = Object.assign({}, ingestDataset, {
        sourceFormat: "json"
      });
  ...
  describe("geojson visualization", () => {
    it("should not be displayed by default", () => {
      const dataset = Object.assign({}, ingestDataset, {
        sourceFormat: "json"
      });
    ...
    it("should not be displayed by default", () => {
      ...
      expect(subject.find(GeoJSONVisualization).props().format).toEqual(
        dataset.sourceFormat
      );
    });

    it("should not be displayed for remote datasets", () => {
      const dataset = Object.assign({}, remoteDataset, {
        sourceFormat: "geojson"
      });
