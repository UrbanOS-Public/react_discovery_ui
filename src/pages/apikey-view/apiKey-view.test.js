...
describe('apiKeyView component generate page', () => {
  const fakeProps = {
    apiKey: '',
    isLoading: false,
    generate: jest.fn(),
...
describe('apiKeyView component confirmation modal', () => {
  let modal
  const fakeProps = {
    apiKey: '',
    isLoading: false,
  ...
  it('Is opened from the Generate button', () => {
    ...
    expect(modal).toHaveClass('apiKey-modal-container')
  })

  it('Contains a generate button', () => {
    const modalGenerateButton = screen.getByRole('button', { name: 'Generate', hidden: true })
...
describe('apiKeyView Component when isLoading', () => {
  const fakeProps = {
    apiKey: '',
    isLoading: true,
    generate: jest.fn(),
...
describe('apiKeyView component display page', () => {
  const fakeProps = {
