...
describe('dataset api doc ', () => {
  ...
  test('the example url should have the dataset id', () => {
    subject = render(<DatasetApiDoc dataset={{ id: 'coda_stuff', name: 'data_name', sourceFormat: 'csv', organization: { name: 'coda_name' }, schema: [{ name: "id" }] }} />)
  ...
  test('the example url maps _format parameter if necessary', () => {
    subject = render(<DatasetApiDoc dataset={{ id: 'coda_stuff', name: 'data_name', sourceFormat: 'gtfs', organization: { name: 'coda_name' }, schema: [{ name: "id" }] }} />)
