    ...
    return (
      <div>
        <div className='example-container'>
          ...
          <div>
            For application development, look at the <a role='link' href='https://www.npmjs.com/package/phoenix' target='_blank' rel='noreferrer'>official Phoenix Javascript library</a>, or one of the <a role='link' href='https://hexdocs.pm/phoenix/channels.html#client-libraries' target='_blank' rel='noreferrer'>other client libraries</a>
          </div>
        </div>
      </div>
    )
